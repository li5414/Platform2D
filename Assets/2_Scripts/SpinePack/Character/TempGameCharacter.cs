...
public class TempGameCharacter : MonoBehaviour
{
    static List<TempGameCharacter> All = new List<TempGameCharacter>();
    ...
    //--------------------------------------------------------------------------
    //input injection
    public System.Action<TempGameCharacter> HandleInput;
    //events
    ...
    {
        foreach (TempGameCharacter gc in All)
		{
			if (gc == this)	continue;
