...
namespace druggedcode.engine
{
	...
	public class DEControllerOld : MonoBehaviour
	{
		//----------------------------------------------------------------------------------------------------------
		// helper 상수들
		//----------------------------------------------------------------------------------------------------------
		...
		public void SetPhysicsSpace (PhysicsData physicInfo)
		{
		...
		{
			_physicSpaceInfo = new PhysicsData (0, 1);
		}
	...
	public class DEControllerState
	{
		...
		{
			IsGroundedInfo = new List<bool> (new bool[DEControllerOld.VERTICAL_RAY_NUM]);
